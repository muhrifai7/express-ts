...
export class Migrations1639734200875 implements MigrationInterface {
    name = 'Migrations1639734200875'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "user" (
                ...
                CONSTRAINT "REL_78cb02d20ca6caa5a95331cbfb" UNIQUE ("module_id"),
