...
export class Migrations1642080717365 implements MigrationInterface {
    name = 'Migrations1642080717365'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            ADD "created_at" TIMESTAMP NOT NULL DEFAULT '2022-01-13 20:31:59'
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE "attendance"
            ADD "updated_at" TIMESTAMP NOT NULL DEFAULT '2022-01-13 20:31:59'
        `);
    }
